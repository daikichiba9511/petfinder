...
def main():
    ...
    if config.inference:
        ...
        test_df["Id"] = test_df["Id"].apply(lambda x: os.path.join(config.root, "test", x + ".jpg"))
        ...
        for fold in range(config.n_splits):
            ...
            predicts = predict(model, test_dataloader, config, transform=get_default_transforms()["test"])
            sub.append(predicts)
